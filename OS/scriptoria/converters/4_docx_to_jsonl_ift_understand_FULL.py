...
OUTPUT_BASE_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, "jsonl_files", "U"))
...
def main():
    print("Starting conversion to Understand format...")
    ...
    for filename in files:
        ...
        out_p = os.path.join(OUTPUT_BASE_DIR, f"{base_name}_UNDERSTAND.jsonl")
        
        print(f"Processing: {filename} -> U/{os.path.basename(out_p)}")
